...
| `h96-max-m9/forky` | h96-max-m9 | forky | `rk3576-mainline-7.2` `v7.2` | `rk3576-fixes`, `rk3576-npu` `main` (`83dd3465ec91`) | `rk3576-display` `main` (`83dd3465ec91`) | `aic8800` `main` (`df4c783b663e`) | `expected` | 2026-08-21 |
| `h96-max-m9/media-accel` | h96-max-m9 | forky | `rk3576-mainline-7.2` `v7.2` | `rk3576-fixes`, `rk3576-npu`, `rk3576-rga` `main` (`83dd3465ec91`) | `rk3576-display` `main` (`83dd3465ec91`) | `aic8800` `main` (`df4c783b663e`) | `experimental` | 2026-08-21 |
| `h96-max-m9/util` | h96-max-m9 | — | (u-boot only) | none | `h96-max-m9-util` `main` (`83dd3465ec91`) | none | `expected` | 2026-07-22 |
| `rk3576-evb1-v10/forky` | rk3576-evb1-v10 | forky | `rk3576-mainline-7.2` `v7.2` | `rk3576-fixes` `main` (`83dd3465ec91`) | `rk3576-loader` `main` (`83dd3465ec91`) | none | `expected` | 2026-08-21 |
| `rk3576-generic/loader` | rk3576-generic | — | (u-boot only) | none | `rk3576-loader` `main` (`83dd3465ec91`) | none | `expected` | 2026-07-21 |
| `rk3576-generic/util` | rk3576-generic | — | (u-boot only) | none | `rk3576-util` `main` (`83dd3465ec91`) | none | `expected` | 2026-07-21 |
